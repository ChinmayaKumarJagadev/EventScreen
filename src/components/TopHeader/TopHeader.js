...
const TopHeader = () => {
    ...
    const pageTitle = location.pathname === routers.OTP ? "Enter OTP" : location.pathname === routers.INFO ? "Your information" : location.pathname === routers.MESSAGE ? "Future Forward Season 1 Epi...": '';
